...
function Nav(){
  ...
  <div className="container-fluid" >
    ...
    <button onClick={nav_open} className="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      <span className="navbar-toggler-icon"></span>
    </button>
    
    <div className="collapse navbar-collapse" id="navbarSupportedContent">
    <button className=" w3-bar-item w3-button w3-large w3-hide-large" onClick={nav_close}>Close &times;</button>
